...
urlpatterns = [
    ...
    url(r'^process/(?P<pk>\d+)/unclaim/$', views.UnclaimProcessView.as_view(), name='process_unclaim'),
    ...
    url(r'^verify/(?P<pk>\d+)/unclaim/$', views.UnclaimVerifyView.as_view(), name='verify_unclaim'),
